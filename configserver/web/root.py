...
class RootServer:
	...
	def index(self, **kwargs):
		...
		#return render_template("index.html", sw_version = sw_version, current_time = datetime.now().strftime("%A, %d. %B %Y %I:%M%p"), os_info = ', '.join(platform.uname()[:4]), notify_color= subprocess.check_output(["echo","#00FFFF"]))
